...
fn panel_bits_are_distinct() {
    use suisei_engine::ffi::{
        SUISEI_PANEL_COMPLETIONS, SUISEI_PANEL_EXPLORER, SUISEI_PANEL_GIT_WB,
        SUISEI_PANEL_OUTLINE, SUISEI_PANEL_PALETTE, SUISEI_PANEL_PREVIEW, SUISEI_PANEL_SCM,
        SUISEI_PANEL_SEARCH, SUISEI_PANEL_SETTINGS, SUISEI_PANEL_TERMINAL,
    };
    let bits = [
