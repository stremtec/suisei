...
pub struct Theme {
    ...
    /// silently move it.
    pub model_bg: Rgba,
    /// The row the debugger is stopped on.
    ///
    /// **Not** `current_line`. That wash marks where the CARET is; this marks
...
impl ThemeToken {
    ...
    pub fn get(self, theme: &Theme) -> Rgba {
        match self {
            ...
            Self::DebugStop => theme.debug_stop,
    ...
    fn set(self, theme: &mut Theme, color: Rgba) {
        ...
        match self {
            ...
            Self::DebugStop => theme.debug_stop = color,
